...
import aiohttp
import sys
print(sys.executable)  # 应为 /home/akun2023/anaconda3/envs/wechatmp/bin/python
print(sys.path)       # 检查是否包含项目目录
sys.path.append('/home/akun2023/dev_deploy/chatgpt-on-wechat-wx849')
import pysilk
